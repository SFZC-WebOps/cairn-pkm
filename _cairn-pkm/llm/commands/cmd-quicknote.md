...
|---------|--------------|-------------|
| `!quicknote` | Capture from conversation | Per user-prefs.yaml |
| `!quicknote [topic]` | Capture specific topic | Per user-prefs.yaml |

**Workflow:** Type `!quicknote` Ã¢â€ â€™ Review proposed content Ã¢â€ â€™ Confirm Ã¢â€ â€™ Output per prefs
...
**Vault Structure:**
- `Capture/` Ã¢â‚¬â€ Inbox for unprocessed items
...
```
Ã¢Å“â€œ Created {VAULT_PATH}/Capture/qn-2025-12-18-143022-api-integration-notes.md
